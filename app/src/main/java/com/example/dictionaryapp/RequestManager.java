...
public class RequestManager {
    ...
    public void getWordMeaning(OnFetchDataListener dataListener, String word){
        ...
        try{
            call.enqueue(new Callback<List<APIResponse>>() {
                ...
                public void onResponse(@NonNull Call<List<APIResponse>> call, @NonNull Response<List<APIResponse>> response) {
                    ...
                    dataListener.onFetchData(response.body().get(0), response.message());
                }

                @Override
                public void onFailure(@NonNull Call<List<APIResponse>> call, @NonNull Throwable t) {
                    dataListener.onError("Request Failed!");
                }
